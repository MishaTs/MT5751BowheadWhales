...
table2 <- data.frame(
	...
	Coefficient of Size = c(6.16, 5.64, -1.53, -0.51),
	SE = c(5046.40, 305.31, 0.60, 0.26),
	Significance of Size = c("Not Significant", "Not Significant", "Significant", "Significant at 0.1 level")
)
...
```{r Raw-data-models, echo = F, fig.cap="Detection functions using raw data"}
par(mfrow = c(2,2))
...
```{r Raw-data-models, echo = F, fig.cap="Detection functions using binned data"}
par(mfrow = c(1,2))
...
```{r Raw-data-models, echo = F, fig.cap="Detection functions using truncated data"}
par(mfrow = c(2,3))
