...
# both models have solid GOF but the covariate model is slightly better from visual QQ inspection
# get rid of ks = TRUE for  improvements
gof_ds(baseTruncHN, main="Base HN Observed vs. Expected CDF")#, ks = TRUE)
gof_ds(sizeTruncHN, main="Covariate HN Observed vs. Expected CDF")#, ks = TRUE)
gof_ds(sizeTruncHR, main="Covariate HR Observed vs. Expected CDF")#, ks = TRUE)
```
